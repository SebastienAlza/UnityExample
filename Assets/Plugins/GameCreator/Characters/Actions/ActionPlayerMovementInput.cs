	...
	public class ActionPlayerMovementInput : IAction 
	{
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
            if (HookPlayer.Instance != null)
            {
                ...
                {
                    player.canRotate = this.canRotate;
        ...
        private SerializedProperty spCanRotate;
		...
		protected override void OnEnableEditorChild ()
		{
            ...
            this.spCanRotate = this.serializedObject.FindProperty("canRotate");
		...
		public override void OnInspectorGUI()
		{
            ...
            {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(this.spCanRotate);
